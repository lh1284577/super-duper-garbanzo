...
function pieChart() {
  ...
  function init() {
    ...
    canvas = document.getElementById('chartA');
  ...
  function startPullOut ( slice ) {
    ...
    $('#chartDataA td').removeClass('highlight');
    var labelCell = $('#chartDataA td:eq(' + (slice*2) + ')');
    var valueCell = $('#chartDataA td:eq(' + (slice*2+1) + ')');
